...
if not on_rtd:
    # suppose that the .so modules have been built with build_ext --inplace
...
latex_documents = [
  (master_doc, 'cycapture.tex', u'cycapture Documentation',
...
man_pages = [
    (master_doc, 'cycapture', u'cycapture Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'cycapture', u'cycapture Documentation',
   author, 'cycapture', 'One line description of project.',
   'Miscellaneous'),
]
